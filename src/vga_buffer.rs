...
pub fn _print(args: fmt::Arguments) {
    ...
    // Disable interrupts as long as Mutex locked
...
pub struct Writer {
    ...
    color_code: ColorCode,
    buffer: &'static mut Buffer, // Store ref to VGA buffer
}
    ...
    pub fn write_byte(&mut self, byte: u8) {
        match byte {
            ...
            byte => {
                ...
                // Use write method instead of assignment
...
fn test_println_output() {
    ...
    interrupts::without_interrupts(|| {
        let mut writer = WRITER.lock(); // Prevent race condition b/t test and timer handler
        writeln!(writer, "\n{}", s).expect("writeln failed");
        // Timer interrupt handler might run b/t println and reading of chars
